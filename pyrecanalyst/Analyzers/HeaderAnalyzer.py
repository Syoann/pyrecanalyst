...
from pyrecanalyst.Model.Team import Team
from pyrecanalyst.Model.ChatMessage import ChatMessage
from pyrecanalyst.Model.GameSettings import GameSettings
from pyrecanalyst.Model.GameInfo import GameInfo
from pyrecanalyst.Analyzers.Analyzer import Analyzer
from pyrecanalyst.Analyzers.PlayerInfoBlockAnalyzer import PlayerInfoBlockAnalyzer
from pyrecanalyst.Analyzers.PlayerMetaAnalyzer import PlayerMetaAnalyzer
from pyrecanalyst.Analyzers.MapDataAnalyzer import MapDataAnalyzer
from pyrecanalyst.Analyzers.VictorySettingsAnalyzer import VictorySettingsAnalyzer
from pyrecanalyst.Analyzers.Aoe2RecordHeaderAnalyzer import Aoe2RecordHeaderAnalyzer
...
class HeaderAnalyzer(Analyzer):
    ...
    def skip_ai(self):
        ...
        self.position += 4096  # ???
        if self.version.sub_version >= 11.96:
            self.position += 1280  # ???

        # TODO is self the correct cutoff point?
        if self.version.sub_version >= 12.3:
